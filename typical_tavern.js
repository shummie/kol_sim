...
// Also, selection of special squares require additional handling.
// We assume that each of the special adventures are equally likely to appear on each square.
...
class tt_sim {
    ...
    constructor() {
        ...
        this.base_c_rate = 0.80;
        this.max_ml_rate = 300; // Assumes 300 ML caps # of drunken rat kings.

        this.turns_taken = 0;
        this.king_count = 0;

        this.possible_ncs = [0, 1, 2, 3]; // For now, we're just simulating possibility of skipped turns.
    };
